<%-- 
    Document   : edit
    Created on : Oct 9, 2020, 6:01:23 PM
    Author     : USER
--%>
            ...
            <div class="login-hny">
                <div class="form-content">
                    ...
                    <div class="form-left">
                        ...
                        <form action="Update" method="POST" style="position: static"  class="signin-form">
                            <div class="form-input">
                                <label>Cake ID</label>
                                <input type="text"  name="cakeID" value="${requestScope.CAKE.IDCake}${requestScope.ID}" readonly="true" placeholder="Username" style="height: 50px" />
                            ...
                            <div class="form-input">
                                ...
                                <select style="background: #fff;
                                        ...
                                        padding: 10px 15px;
                                        color:#090e0d;
                                        border: 2px solid #BECED0;" name="txtStatus">
                                    <option value="Available">Available</option>
                                    <option value="Unavailable">Unavailable</option>
                                </select>
                            </div>

                            <button name="action" value="Update" class="btn">Update</button>
                        </form>
